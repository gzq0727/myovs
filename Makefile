...
am__append_39 = $(bugtool_scripts)
am__append_40 = utilities/bugtool/ovs-bugtool.in
am__append_41 = bugtool-install-data-local
am__append_42 = bugtool-uninstall-local
#am__append_43 = tests/test-dpdkr
am__append_44 = \
...
#am__append_46 = $(TESTPKI_FILES)
#am__append_47 = $(TESTPKI_FILES) tests/ovs-pki.log
#am__append_48 = clean-pki
am__append_49 = .h .hstamp
am__append_50 = $(HSTAMP_FILES)
...
# are acceptable as C++.
#am__append_52 = include/openvswitch/libcxxtest.la
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/odp-util.h lib/ofp-actions.c lib/ofp-ed-props.c \
	lib/ofp-errors.c lib/ofp-msgs.c lib/ofp-parse.c \
	lib/ofp-print.c lib/ofp-prop.c lib/ofp-util.c \
	lib/ofp-version-opt.h lib/ofp-version-opt.c lib/ofpbuf.c \
	...
	lib/svec.h lib/syslog-direct.c lib/syslog-direct.h \
	lib/syslog-libc.c lib/syslog-libc.h lib/syslog-provider.h \
	...
	lib/dpif-netlink-rtnl.h lib/if-notifier.c lib/if-notifier.h \
	lib/netdev-linux.c lib/netdev-linux.h lib/netdev-tc-offloads.c \
	lib/netdev-tc-offloads.h lib/netlink-conntrack.c \
	...
	lib/tc.h lib/dpdk.c lib/netdev-dpdk.c lib/dpdk-stub.c \
	...
	lib/route-table-bsd.c lib/stream-ssl.c lib/stream-nossl.c
...
am__objects_3 = lib/dpif-netlink.lo \
	...
	lib/netdev-linux.lo lib/netdev-tc-offloads.lo \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/ofp-actions.lo lib/ofp-ed-props.lo lib/ofp-errors.lo \
	lib/ofp-msgs.lo lib/ofp-parse.lo lib/ofp-print.lo \
	lib/ofp-prop.lo lib/ofp-util.lo lib/ofp-version-opt.lo \
	lib/ofpbuf.lo lib/ovs-atomic-locked.lo lib/ovs-lldp.lo \
	lib/ovs-numa.lo lib/ovs-rcu.lo lib/ovs-router.lo \
	lib/ovs-thread.lo lib/ovsdb-data.lo lib/ovsdb-error.lo \
	lib/ovsdb-idl.lo lib/ovsdb-map-op.lo lib/ovsdb-set-op.lo \
	lib/ovsdb-condition.lo lib/ovsdb-parser.lo lib/ovsdb-types.lo \
	lib/packets.lo lib/pcap-file.lo lib/perf-counter.lo \
	lib/poll-loop.lo lib/process.lo lib/pvector.lo lib/random.lo \
	lib/rconn.lo lib/reconnect.lo lib/rstp.lo \
	lib/rstp-state-machines.lo lib/seq.lo lib/sha1.lo lib/shash.lo \
	lib/simap.lo lib/skiplist.lo lib/smap.lo lib/socket-util.lo \
...
am_ovn_lib_libovn_la_OBJECTS = ovn/lib/acl-log.lo ovn/lib/actions.lo \
	ovn/lib/chassis-index.lo ovn/lib/expr.lo ovn/lib/lex.lo \
	ovn/lib/ovn-util.lo ovn/lib/logical-fields.lo
...
am_ovn_controller_ovn_controller_OBJECTS =  \
	ovn/controller/bfd.$(OBJEXT) ovn/controller/binding.$(OBJEXT) \
	ovn/controller/chassis.$(OBJEXT) \
	ovn/controller/encaps.$(OBJEXT) \
	ovn/controller/gchassis.$(OBJEXT) \
	ovn/controller/lflow.$(OBJEXT) ovn/controller/lport.$(OBJEXT) \
	ovn/controller/ofctrl.$(OBJEXT) \
...
am__tests_ovstest_SOURCES_DIST = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-stp.c tests/test-unixctl.c tests/test-util.c \
	tests/test-uuid.c tests/test-bitmap.c tests/test-vconn.c \
	tests/test-aa.c tests/test-unix-socket.c \
	tests/test-netlink-conntrack.c
...
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-skiplist.$(OBJEXT) tests/test-stp.$(OBJEXT) \
...
am__noinst_HEADERS_DIST = AUTHORS.rst CONTRIBUTING.rst MAINTAINERS.rst \
	...
	build-aux/dist-docs build-aux/dpdkstrip.pl \
	build-aux/sodepends.pl build-aux/soexpand.pl \
	build-aux/xml2nroff lib/colors.man lib/common.man \
	lib/common-syn.man lib/coverage-unixctl.man lib/daemon.man \
	lib/daemon-syn.man lib/db-ctl-base.man lib/dpctl.man \
	...
	ovn/utilities/ovn-sbctl.8.in ovn/utilities/ovn-detrace.1.in \
	...
	Documentation/requirements.txt $(addprefix \
	Documentation/ref/,$(RST_MANPAGES)) m4/absolute-header.m4 \
	m4/include_next.m4 m4/pkg.m4 lib/stdio.h.in lib/string.h.in \
	lib/dh1024.pem lib/dh2048.pem lib/dh4096.pem lib/common.xml \
	lib/daemon.xml lib/dirs.c.in lib/db-ctl-base.xml lib/ssl.xml \
	lib/ssl-bootstrap.xml lib/table.xml lib/vlog.xml \
	lib/vswitch-idl.ann build-aux/extract-ofp-fields \
	build-aux/extract-ofp-actions build-aux/extract-ofp-errors \
	build-aux/extract-ofp-msgs lib/meta-flow.xml ofproto/ipfix.xml \
	...
	tests/ovsdb-idl.at tests/ovsdb-lock.at tests/ovsdb-rbac.at \
	tests/ovs-vsctl.at tests/ovs-xapi-sync.at tests/stp.at \
	tests/rstp.at tests/interface-reconfigure.at tests/vlog.at \
	tests/vtep-ctl.at tests/auto-attach.at tests/ovn.at \
	tests/ovn-northd.at tests/ovn-nbctl.at tests/ovn-sbctl.at \
	tests/ovn-controller.at tests/ovn-controller-vtep.at \
	tests/mcast-snooping.at tests/packet-type-aware.at \
	tests/nsh.at tests/system-common-macros.at tests/system-ovn.at \
	tests/system-layer3-tunnels.at tests/system-traffic.at \
	tests/system-kmod-testsuite.at tests/system-kmod-macros.at \
	tests/system-userspace-testsuite.at \
	tests/system-userspace-macros.at \
	tests/system-userspace-packet-type-aware.at \
	tests/system-offloads-traffic.at \
	tests/system-offloads-testsuite.at $(srcdir)/tests/testsuite \
	$(srcdir)/tests/system-kmod-testsuite \
	$(srcdir)/tests/system-userspace-testsuite \
	$(srcdir)/tests/system-offloads-testsuite tests/atlocal.in \
	...
	debian/openvswitch-pki.dirs debian/openvswitch-pki.postinst \
	...
	ovsdb/remote-active.xml ovsdb/remote-passive.xml \
	...
	tutorial/ovn-setup.sh vtep/vtep-idl.ann vtep/ovs-vtep.in \
	...
	ovn/utilities/ovn-detrace.in ovn/utilities/ovndb-servers.ocf \
	selinux/openvswitch-custom.te.in include/sparse/arpa/inet.h \
	...
	include/sparse/rte_memcpy.h include/sparse/rte_vect.h \
	...
	include/linux/pkt_cls.h include/linux/tc_act/tc_tunnel_key.h \
...
ACLOCAL = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/missing automake-1.15
AWK = gawk
CAPNG_LDADD = 
...
KARCH = 
KBUILD = /lib/modules/4.4.0-93-generic/build
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
OVS_LDFLAGS = 
OVS_LTINFO = -release 2.8 -version-info 0:0
PACKAGE = openvswitch
PACKAGE_BUGREPORT = bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 2.8.0
...
abs_builddir = /home/gzq/openvswitch-2.8.0
abs_srcdir = /home/gzq/openvswitch-2.8.0
abs_top_builddir = /home/gzq/openvswitch-2.8.0
abs_top_srcdir = /home/gzq/openvswitch-2.8.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/gzq/openvswitch-2.8.0/build-aux/install-sh
...
ALL_LOCAL = dist-hook-git config-h-check printf-check static-check \
	...
	check-ifconfig $(am__append_6) $(am__append_8) $(am__append_9) \
	$(am__append_11) $(am__append_51) cxx-check \
...
CLEANFILES = all-distfiles all-gitfiles missing-distfiles distfiles \
	$(am__append_7) flake8-check manpage-dep-check \
	$(am__append_12) $(nodist_lib_libopenvswitch_la_SOURCES) \
	lib/meta-flow.inc lib/nx-match.inc lib/ofp-actions.inc1 \
	lib/ofp-actions.inc2 lib/ofp-errors.inc lib/ofp-msgs.inc \
	lib/ovs-fields.7 ofproto/ipfix-entities.def \
	utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	utilities/ovs-vlan-test utilities/ovs-vlan-bug-workaround.8 \
	utilities/ovs-vsctl.8 $(am__append_36) $(valgrind_wrappers) \
	$(am__append_47) include/odp-netlink.h $(am__append_50) \
	cxx-check debian/copyright vswitchd/ovs-vswitchd.8 \
	...
	ovsdb/ovsdb-dot vtep/vtep-ctl.8 vtep/ovs-vtep $(am__append_54) \
	vtep/vtep.5 vtep/vtep.ovsschema.stamp \
	$(srcdir)/datapath-windows/include/OvsDpInterface.h \
	$(am__append_56) ovn/ovn-sb.5 $(am__append_57) ovn/ovn-nb.5 \
	ovn/ovn-architecture.7 ovn/ovn-nb.ovsschema.stamp \
	ovn/ovn-sb.ovsschema.stamp ovn/controller/ovn-controller.8 \
	...
	ovn/utilities/ovn-trace.8 ovn/utilities/ovn-detrace.1 \
...
EXTRA_DIST = AUTHORS.rst CONTRIBUTING.rst MAINTAINERS.rst README.rst \
	...
	Vagrantfile-FreeBSD .mailmap build-aux/thread-safety-blacklist \
	$(DOC_SOURCE) m4/absolute-header.m4 m4/include_next.m4 \
	m4/pkg.m4 lib/stdio.h.in lib/string.h.in lib/dh1024.pem \
	lib/dh2048.pem lib/dh4096.pem lib/common.xml lib/daemon.xml \
	lib/dirs.c.in lib/db-ctl-base.xml lib/ssl.xml \
	lib/ssl-bootstrap.xml lib/table.xml lib/vlog.xml \
	lib/vswitch-idl.ann build-aux/extract-ofp-fields \
	build-aux/extract-ofp-actions build-aux/extract-ofp-errors \
	build-aux/extract-ofp-msgs lib/meta-flow.xml ofproto/ipfix.xml \
	...
	$(SYSTEM_OFFLOADS_TESTSUITE_AT) $(TESTSUITE) \
	$(SYSTEM_KMOD_TESTSUITE) $(SYSTEM_USERSPACE_TESTSUITE) \
	$(SYSTEM_OFFLOADS_TESTSUITE) tests/atlocal.in \
...
dist_scripts_DATA = 
INSTALL_DATA_LOCAL = $(am__append_14) lib-install-data-local \
	$(am__append_41)
UNINSTALL_LOCAL = uninstall-man-rst $(am__append_42) \
	ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
...
MAN_ROOTS = utilities/ovs-appctl.8.in \
	...
	utilities/ovs-vlan-bug-workaround.8.in \
	utilities/ovs-vsctl.8.in $(am__append_38) \
	vswitchd/ovs-vswitchd.8.in ovsdb/ovsdb-tool.1.in \
	ovsdb/ovsdb-client.1.in ovsdb/ovsdb-server.1.in \
	ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in \
	ovn/utilities/ovn-sbctl.8.in ovn/utilities/ovn-detrace.1.in
...
lib_LTLIBRARIES = lib/libopenvswitch.la lib/libsflow.la \
	...
	ovn/lib/libovn.la
noinst_LTLIBRARIES = $(am__append_52)
...
FLAKE8_PYFILES = Documentation/conf.py ofproto/ipfix-gen-entities \
	...
	utilities/ovs-dev.py utilities/ovs-tcpdump.in $(am__append_40) \
	$(CHECK_PYFILES) \
	xenserver/usr_share_openvswitch_scripts_ovs-xapi-sync \
...
tests_ovstest_SOURCES = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-stp.c tests/test-unixctl.c tests/test-util.c \
	tests/test-uuid.c tests/test-bitmap.c tests/test-vconn.c \
	tests/test-aa.c $(am__append_44) $(am__append_45)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/ovn/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/include/linux/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/ovn/utilities/bugtool/automake.mk $(srcdir)/selinux/automake.mk $(srcdir)/build-aux/automake.mk $(am__configure_deps)
	@for dep in $?; do \
...
lib/netdev-tc-offloads.lo: lib/$(am__dirstamp) \
	lib/$(DEPDIR)/$(am__dirstamp)
...
ovn/lib/$(DEPDIR)/$(am__dirstamp):
	...
	@: > ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/acl-log.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/actions.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/chassis-index.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
...
ovn/controller/$(DEPDIR)/$(am__dirstamp):
	...
	@: > ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/bfd.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
...
ovn/controller/encaps.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/gchassis.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
...
include lib/$(DEPDIR)/netdev-tc-offloads.Plo
...
include ovn/lib/$(DEPDIR)/acl-log.Plo
include ovn/lib/$(DEPDIR)/actions.Plo
include ovn/lib/$(DEPDIR)/chassis-index.Plo
...
distclean: distclean-recursive
	...
	-rm -rf include/openvswitch/$(DEPDIR) lib/$(DEPDIR) lib/lldp/$(DEPDIR) ofproto/$(DEPDIR) ovn/controller-vtep/$(DEPDIR) ovn/controller/$(DEPDIR) ovn/lib/$(DEPDIR) ovn/northd/$(DEPDIR) ovn/utilities/$(DEPDIR) ovsdb/$(DEPDIR) tests/$(DEPDIR) tests/dpdk/$(DEPDIR) utilities/$(DEPDIR) vswitchd/$(DEPDIR) vtep/$(DEPDIR)
	-rm -f Makefile
