			      ...
			      const struct nlattr *attr, int len)
{
	...
	for (a = attr, rem = len; rem > 0;
		...
		case OVS_ACTION_ATTR_OUTPUT: {
			 ...
			 */
			printk(KERN_INFO "do_execute_actions:output\n");
		...
		case OVS_ACTION_ATTR_TRUNC: {
			...
			printk(KERN_INFO "do_execute_actions:trunc\n");
		...
		case OVS_ACTION_ATTR_USERSPACE:
			printk(KERN_INFO "do_execute_actions:userspace\n");
		...
		case OVS_ACTION_ATTR_HASH:
			printk(KERN_INFO "do_execute_actions:hash\n");
		...
		case OVS_ACTION_ATTR_RECIRC: {
			...
			printk(KERN_INFO "do_execute_actions:recirc\n");
			if (last) {
		...
		case OVS_ACTION_ATTR_SET:
			printk(KERN_INFO "do_execute_actions:set\n");
		...
		case OVS_ACTION_ATTR_SAMPLE: {
			bool last = nla_is_last(a, rem);
			printk(KERN_INFO "do_execute_actions:sample\n");
