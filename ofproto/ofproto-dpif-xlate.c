...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log9.txt", "a+");
    fprintf(fp,"info:run into xlate_recursively!\n");
    fflush(fp);
    ...
    if (ctx->xin->resubmit_stats) {
        fprintf(fp,"info:ctx->xin->resubmit");
        fflush(fp);
    ...
    fprintf(fp,"run do_xlate_actions\n\n");
    fflush(fp);
    fclose(fp);
                  ...
                  struct ofputil_bucket *bucket)
{
    ...
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log2.txt", "a+");
    fprintf(fp,"info:run into xlate_group_stats!\n");
    fflush(fp);
    ...
    if (ctx->xin->resubmit_stats) {
        ...
        fprintf(fp,"info:ctx resubmit stats\n");
        fflush(fp);

        group_dpif_credit_stats(group, bucket, ctx->xin->resubmit_stats);
    }
    if (ctx->xin->xcache) {
        fprintf(fp,"info:ctx xcache\n");
        fflush(fp);
        fclose(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log1.txt", "a+");
    fprintf(fp,"info:run into xlate_group_bucket!\n");
    fflush(fp);
    ...
    if (ctx->freezing) {
        fprintf(fp,"info:ctx freezing");
        fflush(fp);
        fclose(fp);
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f2:get last time form hash table start!\n");
//    fflush(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log10.txt", "a+");
    fprintf(fp,"xlate_all_group\n");
    fflush(fp);

    struct ofputil_bucket *bucket;
    LIST_FOR_EACH (bucket, list_node, &group->up.buckets) {

        fprintf(fp,"run xlate_group_bucket\n");
        fflush(fp);
    ...
    fprintf(fp,"xlate_all_group run over");
    fflush(fp);
    fclose(fp);
}
...
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f1:caculate hash key start!\n");
//    fflush(fp);
    ...
    //fprintf(fp,"f1:caculate hash key end!\n");
    //fflush(fp);
    //fclose(fp);
...
static
struct last_time_hash *get_last_time(uint32_t hash_key){
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f2:get last time form hash table start!\n");
//    fflush(fp);
    ...
    HASH_FIND_INT(last_times, &hash_key, s);

//    fprintf(fp,"f2:get last time from hash table end!\n");
//    fflush(fp);
//    fclose(fp);
...
static void
update_last_time_hash (uint32_t hash_key, struct timeval current_time){
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f3:update last time in hash table start!\n");
//    fflush(fp);

    struct last_time_hash *s;
    s = get_last_time(hash_key);
    if(s == NULL){
//        fprintf(fp,"f3:last time for hashkey not exist,add\n");
//        fflush(fp);

        s = malloc(sizeof(struct last_time_hash));
        s->key = hash_key;
        memcpy(&s->t_val, &current_time, sizeof(struct timeval));
        HASH_ADD_INT( last_times, key, s );

//        fprintf(fp,"f3:last time for new hashkey added\n");
//        fflush(fp);
    }
    else{
        s->t_val = current_time;

//        fprintf(fp,"f3:update last time for hashkey\n");
//        fflush(fp);
    }

//    fprintf(fp,"f3:update last time in hash table end!\n");
//    fflush(fp);
//    fclose(fp);
}

static
struct last_output_port_hash *get_last_output_port(uint32_t hash_key){
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f4:get last output port start!\n");
//    fflush(fp);

    struct last_output_port_hash *s;
    HASH_FIND_INT(last_output_ports, &hash_key, s);

//    fprintf(fp,"f4:get last output port end!\n");
//    fflush(fp);
//    fclose(fp);
...
static void
update_last_output_port_hash (uint32_t hash_key, uint32_t last_out_port){
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f5:update last output port in hash table start!\n");
//    fflush(fp);

    struct last_output_port_hash *s;
    s = get_last_output_port(hash_key);
    if(s == NULL){
//        fprintf(fp,"f5:last output port for hashkey not exist,add\n");
//        fflush(fp);

        s = malloc(sizeof(struct last_output_port_hash));
        s->key = hash_key;
        s->last_output_port = last_out_port;
        HASH_ADD_INT( last_output_ports, key, s );
//        fprintf(fp,"f5:last output port for new hashkey added\n");
//        fflush(fp);
    }
    else{
        s->last_output_port = last_out_port;
//        fprintf(fp,"f5:update last outport for hashkey\n");
//        fflush(fp);
    }

//    fprintf(fp,"f5:update last output port in hash table end!\n");
//    fflush(fp);
//    fclose(fp);
}
...
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f7:caculate random index start!\n");
//    fflush(fp);
...
//    fprintf(fp,"f7:caculate random index end!\n");
//    fflush(fp);
//    fclose(fp);
...
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f8:get output port from bucket start!\n");
//    fflush(fp);

    if (bucket_is_alive(ctx, sel_bucket, 0)){
//        fprintf(fp,"f8:bucket is alive\n");
//        fflush(fp);
...
//        fprintf(fp,"f8:write actions to action set!\n");
//        fflush(fp);

        ofpacts_execute_action_set(&action_list, &action_set); // copy the actions in action_set to action_list

//        fprintf(fp,"f8:copy actions from action set to action list\n");
//        fflush(fp);
...
//                fprintf(fp,"f8:action type is output,get output port\n");
//                fprintf(fp,"f8:get output port from bucket end!\n");
//                fclose(fp);
...
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f9:get flowlet last action bucket start!\n");
//    fflush(fp);

    struct ofputil_bucket *bucket = NULL;

    LIST_FOR_EACH (bucket, list_node, &group->up.buckets) {
//        fprintf(fp,"f9:get one bucket from group buckets\n");
//        fflush(fp);

        if (bucket_is_alive(ctx, bucket, 0)) {
//            fprintf(fp,"f9:bucket is alive\n");
//            fflush(fp);
...
//            fprintf(fp,"f9:write actions to action set!\n");
//            fflush(fp);

            ofpacts_execute_action_set(&action_list, &action_set); // copy the actions in action_set to action_list

//            fprintf(fp,"f9:copy actions from action set to action list\n");
//            fflush(fp);

//            const struct ofpact *ofpacts = &action_list;
//            size_t ofpacts_len = &action_set;
            ...
            OFPACT_FOR_EACH (a, ofpacts, ofpacts_len) {
                if(a->type == OFPACT_OUTPUT){
//                    fprintf(fp,"f9:action type is output,get output port\n");
//                    fflush(fp);

                    if(ofpact_get_OUTPUT(a)->port == output_port){
//                        fprintf(fp,"f9:the output port in bucket equals last output port,get bucket\n");
//                        fprintf(fp,"f9:get flowlet last action bucket from group buckets end!\n");
//                        fclose(fp);
...
//    FILE *fp;
//    fp = fopen("/home/gzq/flowlet_log.txt", "a+");
//    fprintf(fp,"f10:random select one bucket for new flowlet start!\n");
//    fflush(fp);
    ...
    LIST_FOR_EACH (bucket, list_node, &group->up.buckets){
//        fprintf(fp,"f10:get one bucket from group buckets\n");
//        fflush(fp);
...
//        fprintf(fp,"f10:add bucket to link table\n");
//        fflush(fp);
    }

//    fprintf(fp,"f10:check whether the bucket list is NULL\n");
//    fflush(fp);

    //check whether the bucket list is NULL
    if(head->next == NULL){
//        fprintf(fp,"f10:get no cucket from group,head->next is NULL\n");
        return NULL;
    }

//    fprintf(fp,"f10:get total bucket number\n");
//    fflush(fp);
...
//        fprintf(fp,"f10:bucket number %d\n",bucket_num);
//        fflush(fp);

        count_bucket = count_bucket->next;
    }

//    fprintf(fp,"f10:get link table size %d\n",bucket_num);
//    fflush(fp);
...
//    fprintf(fp,"f10:get random select bucket\n");
//    fflush(fp);

    bucket = bucket_find->bucket;

//    fprintf(fp,"f10:random select one bucket for new flowlet end!\n");
//    fclose(fp);
...
xlate_hash_fields_select_group(struct xlate_ctx *ctx, struct group_dpif *group)
{
    ...
    fprintf(fp,"f11:packet counter %" PRId64 "\n",++packet_count);
    //fflush(fp);
...
//    uint32_t ip_src = 3232239617;
//    uint32_t ip_dst = 3232239618;
//    uint16_t tcp_src = 65530;
//    uint16_t tcp_dst = 65531;
...
//    fprintf(fp,"f11:get current time\n");
//    fflush(fp);

    //2.get last time for flow
    struct last_time_hash *lt;
    struct timeval last_time;
    lt = get_last_time(key);

//    fprintf(fp,"f11:get last time\n");
//    fflush(fp);
    ...
    if (lt == NULL) { //new flow
        fprintf(fp,"f11:new flow\n");
        //fflush(fp);

        update_last_time_hash(key, current_time);//add time for new flowlet to hash table

//        fprintf(fp,"f11:update last time in hash table\n");
//        fflush(fp);

        bucket = get_flowlet_random_bucket(group);

//        fprintf(fp,"f11:random select one bucket for new flow\n");
//        fflush(fp);

        output_port = get_output_port_from_bucket(ctx, bucket);

//        fprintf(fp,"f11:record output port from random select bucket\n");
//        fflush(fp);

        update_last_output_port_hash(key, output_port);//add output port for new flowlet to hash table

//        fprintf(fp, "f11:update last ouput port hash table\n");
//        fflush(fp);
...
//        fprintf(fp,"f11:get last time for this packet\n");
//        fflush(fp);
        ...
        fprintf(fp, "f11:diff time:%64lu\n", time_diff);
        //fflush(fp);

        //record new lasttime for flowlet
        update_last_time_hash(key, current_time);

//        fprintf(fp,"f11:update last time hash table\n");
//        fflush(fp);

        //3.if timeout is occured, random choose one output port and record
        if (time_diff >= timeout) {//trigger a new flowlet
            fprintf(fp, "f11:timeout! trigger a new flowlet\n");
            fprintf(fp,"f11:flowlet counter %" PRId64 "\n",++flowlet_count);
            //fflush(fp);

            bucket = get_flowlet_random_bucket(group);

//            fprintf(fp,"f11:random select one bucket from group for new flowlet\n");
//            fflush(fp);
...
//            fflush(fp);
            ...
            update_last_output_port_hash(key,output_port);

//            fprintf(fp, "f11:update last ouput port in hash table\n");
//            fflush(fp);

        } else {//not trigger a new flowlet
            fprintf(fp,"f11:not timeout!\n");
            fflush(fp);
            //fflush(fp);

            struct last_output_port_hash *s;

            s = get_last_output_port(key);
            output_port = s->last_output_port;

//            fprintf(fp,"f11:get last output port for this packet\n");
//            fflush(fp);

            bucket = get_flowlet_last_bucket(ctx, group, output_port);

//            fprintf(fp, "f11:get action bucket according last output port for this packet\n");
//            fflush(fp);
        }
    }

    fprintf(fp, "f11:output port:%64u\n", output_port);
    fflush(fp);
...
//    fprintf(fp,"f11:flowlet switch over\n\n");
//    fflush(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log8.txt", "a+");
    fprintf(fp,"info:run into xlate_select_group\n");
    fflush(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log7.txt", "a+");
...
//        fprintf(fp,"info:group action indirect\n");
//        fflush(fp);
//        fclose(fp);
        ...
        break;
    case OFPGT11_SELECT:
        fprintf(fp,"info:group action select\n");
        fflush(fp);
        fclose(fp);
        ...
        break;
    case OFPGT11_FF:
//        fprintf(fp,"info:group action fast forward\n");
//        fflush(fp);
//        fclose(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log6.txt", "a+");
    fprintf(fp,"info:run into xlate_group_action\n");
    fflush(fp);


    if (xlate_resubmit_resource_check(ctx)) {
        fprintf(fp,"info:xlate_resubmit_resource_check\n");
        fflush(fp);
        ...
        if(ctx->xin->xcache){
            ...
            fprintf(fp,"ctx->xin->xcache is not null\n");
            fflush(fp);
        ...
        fprintf(fp,"info:run xlate_group_action_\n\n");
        fflush(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log11.txt", "a+");
    fprintf(fp,"run into compose_clone\n");
    fflush(fp);
    ...
    if (reversible_actions(oc->actions, oc_actions_len)) {
        ...
        fprintf(fp,"reversible_actions run do_xlate_actions\n");
        fflush(fp);
    ...
    if (ctx->xbridge->support.clone) { /* Use clone action */
        ...
        fprintf(fp,"ctx->xbridge->support.clone run do_xlate_actions\n");
        fflush(fp);
    ...
    if (ctx->xbridge->support.sample_nesting > 3) {
        ...
        fprintf(fp,"ctx->xbridge->support.sample_nesting run do_xlate_actions\n");
        fflush(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log5.txt", "a+");
    fprintf(fp,"info:run into xlate_action_set %" PRId64 "\n", xlate_action_set_count += 1);
    fflush(fp);
    ...
    if (action_list.size) {
        ...
        fprintf(fp,"info:action_list size is not none\n");
        fflush(fp);
        ...
        fprintf(fp,"info: run do_xlate_actions\n");
        fflush(fp);

        do_xlate_actions(action_list.data, action_list.size, ctx);

        fprintf(fp,"info:do_xlate_actions run over\n");
        fflush(fp);
    ...
    fprintf(fp,"info:xlate_action_set run over\n\n");
    fflush(fp);
    fclose(fp);
...
{
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log12.txt", "a+");
    fprintf(fp,"run into compose_conntrack_action\n");
    fflush(fp);
                 ...
                 struct xlate_ctx *ctx)
{
    ...
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log3.txt", "a+");

    fprintf(fp, "info:do_xlate_actions counter %" PRId64 "\n",  group_action_packet_counter += 1);
    fflush(fp);
    ...
    if (ovs_native_tunneling_is_on(ctx->xbridge->ofproto)) {
        ...
        fprintf(fp,"ovs_natice_tunneling_is_on\n");
        fflush(fp);
    }
    ...
    OFPACT_FOR_EACH (a, ofpacts, ofpacts_len) {
        fprintf(fp,"info:OFPACT_FOR_EACH\n");
        fflush(fp);
        ...
        case OFPACT_GROUP:
            fprintf(fp,"info: OFPACT_GROUP\n");
            fprintf(fp,"info:run xlate_group_action\n");
            fflush(fp);
            ...
            if (xlate_group_action(ctx, ofpact_get_GROUP(a)->group_id)) {
                ...
                fprintf(fp,"terminates action list translation\n\n");
                fflush(fp);
...
xlate_actions(struct xlate_in *xin, struct xlate_out *xout)
{
    ...
    FILE *fp;
    fp = fopen("/home/gzq/flowlet_log4.txt", "a+");
    fprintf(fp,"info:run into xlate_actions %" PRId64 "\n", xlateActionsCount += 1);
    fflush(fp);
    ...
    *xout = (struct xlate_out) {
    ...
    xin->trace = xlate_report(&ctx, OFT_BRIDGE, "bridge(\"%s\")",
                              xbridge->name);
    if (xin->frozen_state) {
        fprintf(fp,"info:xin->frozen_sate");
        fflush(fp);
        ...
        if (state->action_set_len) {
            fprintf(fp,"info:restore action set\n");
            fflush(fp);
    ...
    if (flow->tunnel.flags & FLOW_TNL_F_UDPIF) {
        ...
        fprintf(fp,"!flow->tunnel.metadate.tab\n");
        fflush(fp);
    ...
    if (flow->packet_type != htonl(PT_ETH) && in_port &&
        ...
        fprintf(fp,"flow->packet_type!=htonl\n");
        fflush(fp);
    ...
    if (!xin->ofpacts && !ctx.rule) {
        fprintf(fp,"rule_dpif_lookup_from_table\n");
        fflush(fp);


        if (ctx.xin->resubmit_stats) {
            fprintf(fp,"ctx.xin->resubmit_stats is not null\n");
            fflush(fp);
        }
        if (ctx.xin->xcache) {
            fprintf(fp, "ctx.xin->xcache is not null\n");
        ...
        if(ctx.rule){
            ...
            fprintf(fp,"before rule lookup from table action len %16u\n",ctx.rule->up.actions->ofpacts->len);
            fflush(fp);
        }
        ...
        if(ctx.rule->up.actions->has_groups){

            fprintf(fp,"actions contain group\n");
            fflush(fp);

        }


        fprintf(fp,"after rule lookup from table action len %16u\n",ctx.rule->up.actions->ofpacts->len);
        fflush(fp);
...
//            ofproto_rule_ref(&ctx.rule->up);
    ...
    if (!xin->frozen_state && in_port && in_port->is_tunnel) {
        fprintf(fp,"!xin->frozen_state && in_port\n");
        fflush(fp);

        if (ctx.xin->resubmit_stats) {
            fprintf(fp,"ctx.xin->resubmitz_stats\n");
            fflush(fp);

            netdev_vport_inc_rx(in_port->netdev, ctx.xin->resubmit_stats);
            if (in_port->bfd) {
                fprintf(fp,"in_port->bfd\n");
                fflush(fp);
    ...
    if (!xin->frozen_state && process_special(&ctx, in_port)) {
        ...
        fprintf(fp,"!xin->frozen_state && process_special\n");
        fflush(fp);

    } else if (in_port && in_port->xbundle
               && xbundle_mirror_out(xbridge, in_port->xbundle)) {

        fprintf(fp,"in_port && in_port->xbundle && xbundle_mirror_out\n");
        fflush(fp);
        ...
        fprintf(fp,"sampling is done on initial reception; don't redo after thawing\n");
        fflush(fp);


        unsigned int user_cookie_offset = 0;
        if (!xin->frozen_state) {
            fprintf(fp,"!xin->frozen_state\n");
            fflush(fp);
        ...
        if (tnl_process_ecn(flow)
            ...
            fprintf(fp,"tnl_process_ecn(flow)\n");
            fflush(fp);
            ...
            if (!ctx.freezing) {
                fprintf(fp,"!ctx.freezing\n");
                fprintf(fp,"info: run xlate_action_set\n");
                fflush(fp);
        ...
        if (!ctx.freezing
            ...
            fprintf(fp,"!ctx.freezing && xbridge->has_in_band\n");
            fflush(fp);
    ...
    if (nl_attr_oversized(ctx.odp_actions->size)) {
        ...
        fprintf(fp,"too_many_output_actions\n");
        fflush(fp);
    ...
    if (xbridge->netflow && !xin->frozen_state) {
        if (ctx.xin->resubmit_stats) {
            ...
            fprintf(fp,"ctx.xin->resubmit_stats\n");
            fflush(fp);
    ...
    fprintf(fp,"xlate_actions run over\n\n");
    fflush(fp);
    fclose(fp);
